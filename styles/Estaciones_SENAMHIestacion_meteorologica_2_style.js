var size = 0;
var placement = 'point';
function categories_Estaciones_SENAMHIestacion_meteorologica_2(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Autom�tica':
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case 'Autom�tica telem�trica GPRS':
                    return [ new ol.style.Style({
...
case 'Satelital':
                    return [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 0.0 + size, points: 3,
...
default:
        ...
        image: new ol.style.Circle({radius: 4.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(97,213,103,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_Estaciones_SENAMHIestacion_meteorologica_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("tipo_estac");
    ...
    var style = categories_Estaciones_SENAMHIestacion_meteorologica_2(feature, value, size, resolution, labelText,
