...
map.getView().fit([-74.323933, -25.118468, -52.775747, -9.292832], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ESTACIONES METEOROLOGIAS DE BOLIVIA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (141 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Trabajo realizado para la materia de SIG., de la maestria en Ciencias Geomaticas de la Carrera de Geodesia Topografia y Geomatica de la UMSA.';
            }
